...
<article class="post-195 page type-page status-publish has-post-thumbnail entry" itemscope itemtype="https://schema.org/CreativeWork">
  ...
  <div class="entry-content" itemprop="text">
    <div id="wrapper" style="max-width:960px;margin:10px auto">
      <div id="player"> 
        <video id="video" width="100%" height="auto" controls autoplay> 
          <source src="http://wowza.thefatherscall.org:1935/live/smil:livestream.smil/playlist.m3u8" type="video/mp4"> 
          Your browser does not support the video tag.
          <img src="livestream.jpg" alt="fallback"/> 
        </video> 
      </div>
		</div>
    ...
    <div style="text-align:center">
    	<a href="rtsp://wowza.thefatherscall.org:1935/live/livestream" id="android">Fallback Player</a>
    </div>
    <div style="text-align:center">
